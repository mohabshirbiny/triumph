        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{asset('assets/triumph-logo.png')}}" alt="AdminLTE Logo" class="brand-image  " style="opacity: 0.8;" />
                    <span style="font-size: 18px;" class="brand-text font-weight-light">Triumph Hotel</span>
                </a>
