...
@section("page_title", "Create Event Organizer")
@section("content")
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add new Event Organizer</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="post" action="{{ route('events-organizers.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="exampleInputEmail1">title (en)</label>
                                            <input type="url" name="website" value='{{old('website')}}' class="form-control" placeholder="Enter website" />
