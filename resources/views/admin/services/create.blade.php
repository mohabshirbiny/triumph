                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="text[ar]" class="form-control" id="" cols="30" rows="2">{{old('text.ar')}}</textarea>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="exampleInputEmail1">text (en)</label>
                                            <textarea name="text[en]" class="form-control" id="" cols="30" rows="2">{{old('text.en')}}</textarea>
                                        </div>
                                    </div>
