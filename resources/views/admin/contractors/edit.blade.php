                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="post" action="{{ route('contractors.update', $id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="contractor_category_id" class="form-control">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if($details->contractor_category_id == $category->id) selected @endif>{{ json_decode($category->name, true)['en'] . " - " . json_decode($category->name, true)['ar'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/contractor_files/' . $details->logo) }}" alt="">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/contractor_files/' . $details->cover) }}" alt="">
                                            <div class="input-group">
                                                <div class="custom-file">
