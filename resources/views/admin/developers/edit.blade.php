                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" id="quickForm" method="post" action="{{ route('developers.update', $id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/developer_files/' . $details->logo) }}" alt="">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img style="width: 50px;" src="{{ url('images/developer_files/' . $details->cover) }}" alt="">
                                            <div class="input-group">
                                                <div class="custom-file">
